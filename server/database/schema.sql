-- Workshop Job Tracker — PostgreSQL Schema
...
CREATE TABLE IF NOT EXISTS jobs (
    ...
    status VARCHAR(50) NOT NULL DEFAULT 'pending' CHECK (status IN ('pending', 'assigned', 'in_progress', 'waiting_parts', 'completed', 'delivered')),
...
CREATE TABLE IF NOT EXISTS job_parts (
    ...
    unit_price_at_time NUMERIC(10,2) NOT NULL DEFAULT 0,
    created_at TIMESTAMPTZ NOT NULL DEFAULT NOW(),
